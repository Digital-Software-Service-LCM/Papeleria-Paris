...
?>
    ...
    <body>
<!--Define las funciones que tiene permitido realizar  el bodeguero por cada modulo en el que interactua-->
            ...
            <ul class="list">
              <li class="item">
                ...
                <div class="content content_prod"><span class="picto"></span>
                  <a href="bodeguero_producto.php">
                    <h1>Productos</h1>
                  </a>
                  <p>Registrar <br> Consultar <br> Actualizar <br> Eliminar</p>
                </div>
              </li>
              <li class="item">
                <input type="radio" id="radio_Proveedores" name="basic_carousel" value="Proveedores" />
                <label class="Prov" for="radio_Proveedores">Proveedores</label>
                <div class="content content_prov"><span class="picto"></span>
                  <a href="bodeguero_consultar_prov.php">
                    <h1>Proveedores</h1>
                  </a>
                  <p>Consultar</p>
                </div>
              ...
              <li class="item">
                <input type="radio" id="radio_Compras" name="basic_carousel" value="Compras" />
                <label class="compra" for="radio_Compras">Compras</label>
                <div class="content content_compra"><span class="picto"></span>
                  <a href="bodeguero_compras.php">
                    <h1>Compras</h1>
                  </a>
                  <p>Registrar</p>
                </div>
...
<!--Se definen las imagenes de cada modulo-->
            <div class="slide">
