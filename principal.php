    <?php
// Control de sesionea administrador
    session_start();
...
?>
    ...
    <body>
<!--Carrusel que muestra las funciones a las que tiene acceso-->
            ...
            <ul class="list">
              ...
              <li class="item">
                ...
                <div class="content content_venta"><span class="picto"></span>
                  ...
                  <p>Registrar <br> Consultar: <br> Generar Factura <br> Generar Reporte</p>
                </div>
              </li>
            </ul>
          </div>
