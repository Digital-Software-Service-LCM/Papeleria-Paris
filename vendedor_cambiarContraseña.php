...
?>
<!--Obtener informacion del usuario segun el codigo-->
<?php
...
<!--Formulario para el cambio de la contraseña -->
<body style="background-color: #FFB4A7;">
    <div class="formulario-venta">
        ...
        <form method="POST" action="v_procesar_actualizar_contraseña_usuarios.php"><br>
