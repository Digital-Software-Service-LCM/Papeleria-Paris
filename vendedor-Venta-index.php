...
<title>Ventas</title>
    ...
    <body>
        ...
        <table border='1'>
            ...
            foreach ($productos as $p) {
                echo "<tr>";
                    ...
                    echo "<td>".$p->stock."</td>";
                    echo "<td>";
                        echo "<form action='vendedor-Venta-agregar.php' method='post'>";
        ...
        <!-- <a href="Venta-ventas.php">Listado de ventas</a> -->
        <!-- Posibles mensajes de error para la cantidad ingresada-->
        <?php
        if(isset($_GET["m"])){
            $m = $_GET["m"];
        ...
        ?>
        <!--Tabla con el listado de los productos a vender-->
        <?php
session_start();
            ...
            echo "<table border='1'>";
                ...
                foreach ($carrito as $p) {
                    echo "<tr>";
                        ...
                        echo "<td>";
                            echo "<a href='vendedor-Venta-eliminarProdCar.php?in=$i'><i class='fa-solid fa-trash-can' id='icono'></a>";
                        echo "</td>";
                        $total += $p->subTotal;
                        $i++;
                    echo "</tr>";
                ...
                echo "<tr>";
                    echo "<td colspan='7'>";
                        echo "<form action='vendedor-Venta-generarVenta.php' method='post'>";
                            echo "<input type='submit' id='boton1' value='Comprar'>";
                        echo "</form>";
                    echo "</td>";
                echo "</tr>";
            echo "</table>";
