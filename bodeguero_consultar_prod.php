...
<!--trae los datos de todos los productos registrados en la base de datos en una tabla -->
        ...
        <div class="container-table-prod">
            ...
            ?>
                ...
                <div class="table__item">
                    <!--trae el codigo para actualizar o eliminar el producto si es necesario -->
                    <a href="bodeguero_actualizar_prod.php?prodCodigo=<?php echo $row["prodCodigo"]; ?>"><i class="fa-solid fa-pencil" id="icon-table-update"></i></a>
                    <a href="bodeguero_procesar_eliminar_prod.php?prodCodigo=<?php echo $row["prodCodigo"]; ?>" class="icon-table-delete"><i class="fa-solid fa-trash-can" id="icon-table-delete"></i></a>
                </div>
