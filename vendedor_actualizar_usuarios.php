...
?>
<!-- Traer informacion del usuario segun el codigo --> 
<?php
...
<!-- Formulario que muestra la informacion del usuario y le permite actualizarlo-->
<body style="background-color: #FFB4A7;">
    <div class="formulario-venta">
        ...
        <form method="POST" action="v_procesar_actualizar_usuarios.php"><br>
