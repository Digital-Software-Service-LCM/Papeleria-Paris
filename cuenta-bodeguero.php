...
$usuario = "SELECT * FROM usuario where usuRol = 'bodeguero'";
?>
<html lang="es">
...
<body style="background-color: #FFB4A7;">
    ...
    <!-- <h1>Mi cuenta</h1> -->
        ...
        <?php $resultado = mysqli_query($conexion, $usuario);
            ...
            ?>
    <!--trae la informacion personal y de acceso del bodeguero-->
    <p> <b>Informacion Personal:</b> </p> <br>
                ...
                <!--redirige al bodeguero a una pagina para actualizar su informacion personal.-->
                <a href="bodeguero_actualizar_usuarios.php?usuCodigo=<?php echo $row["usuCodigo"]; ?>" class="enlace">Actualizar Informacion</i></a>
                <br><br>
        <p> <b> Informacion de acceso: </b> </p>   <br>
                
              Rol: <input type="text" value="<?php echo $row["usuRol"]; ?>" name="usuRol" disabled><br>
              Contraseña: <br>
                <input type="text" value="<?php echo $row["usuContraseña"]; ?>" name="usuContraseña" disabled ><br>
              Estado:<br>
                <input type="text" value="<?php echo $row["usuEstado"]; ?>" name="usuEstado" placeholder="activo o inactivo" disabled><br><br>
                <!--le permite al bodeguero cambiar la contraseña-->
                <a href="bodeguero_cambiarContraseña.php?usuCodigo=<?php echo $row["usuCodigo"]; ?>" class="enlace">Cambiar Contraseña</i></a><br><br><br>
